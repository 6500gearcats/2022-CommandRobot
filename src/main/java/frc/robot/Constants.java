...
public final class Constants {
    ...
    public static final class DriveConstants {
      ...
      public static final class VisionConstants {
        ...
        public static final double pLinearGain = 0.05;   //Proportional gain control for the linear movement of the robot 
        public static final double iLinearGain = 0.000;  //Integral gain control for the linear movement of the robot
        public static final double dLinearGain = 0.000;    //Derivative gain control for the linear movement of the robot
