...
public final class Constants {
    ...
    public static final class DriveConstants {
      ...
      public static final class VisionConstants {
        ...
        public static final double pLinearGain = 0.005;   //Proportional gain control for the linear movement of the robot 
        public static final double iLinearGain = 0.0005;  //Integral gain control for the linear movement of the robot
        public static final double dLinearGain = 0.0001;    //Derivative gain control for the linear movement of the robot
