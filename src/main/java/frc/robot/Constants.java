...
public final class Constants {
    ...
    public static final class DriveConstants {
      ...
      public static final class VisionConstants {
        ...
        public static final double pLinearGain = 0.04;   //Proportional gain control for the linear movement of the robot 
        public static final double iLinearGain = 0.002;  //Integral gain control for the linear movement of the robot
